...
class SelfSupEstimator(BaseArchitecture, metaclass=ABCMeta):
    """SelfSupEstimator Architecture.
...
class ImageSelfSupEstimator(SelfSupEstimator):
...
class VideoSelfSupEstimator(SelfSupEstimator):
